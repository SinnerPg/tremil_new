...
export default function digitalPrint() {
    return (
        <div className="flex h-full w-full flex-col 2xl:pt-20">
            <Header image="digitalPrint_header.png" title="STAMPA DIGITALE" />
            <div className="flex xl:flex-row xl:justify-between w-full xl:px-24">
              ...
              <div className="hidden xl:flex flex-col xl:w-4/12 xl:mt-20">
                    <img className="w-10/12 mb-6" src="digital_1.png" alt="digital" />
                    <img className="w-10/12 mb-6" src="digital_2.png" alt="digital" />
                    <img className="w-10/12 mb-6" src="digital_3.png" alt="digital" />
              </div>
            </div>
